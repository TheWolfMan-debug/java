...
public final class Md5Util {
	...
	public static void main(String[] args) throws Exception{
		...
		String passwordMD51 = Md5Util.encodeByMd5(password1);
		System.out.println(password1);
		System.out.println(passwordMD51);
		System.out.println("--------------------------------------------------------------");
		String password2 = "123456";
		String passwordMD52 = Md5Util.encodeByMd5(password2);
		System.out.println(password2);
		System.out.println(passwordMD52);
		System.out.println("--------------------------------------------------------------");
		System.out.println(passwordMD52.equals(passwordMD51));
	}
}
